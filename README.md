...
```bash
clocktower-img2json \
  --image-url "https://github.com/user-attachments/assets/15972d4a-8c17-4e9f-b008-37a6de4b2551" \
...
curl -X POST http://localhost:8000/scripts/from-image \
  ...
  -d '{"image_url":"https://github.com/user-attachments/assets/15972d4a-8c17-4e9f-b008-37a6de4b2551"}'
```
